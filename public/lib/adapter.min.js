              ...
              module.exports = function (window, edgeVersion) {
                ...
                Object.defineProperty(
                  ...
                  (RTCPeerConnection.prototype._gather = function (
                    ...
                    var pc = this,
                      iceGatherer =
                        this.transceivers[sdpMLineIndex].iceGatherer;
                    ...
                    if ("offer" === description.type)
                      (sections = SDPUtils.splitSections(description.sdp)),
                        ...
                        sections.forEach(function (
                          ...
                          pc.transceivers[sdpMLineIndex].localCapabilities =
                            caps;
                        }),
                  ...
                  (RTCPeerConnection.prototype.setRemoteDescription = function (
                    ...
                    return (
                      (pc.canTrickleIceCandidates =
                        !!iceOptions &&
                        iceOptions.substr(14).split(" ").indexOf("trickle") >=
                          0),
                      sections.forEach(function (mediaSection, sdpMLineIndex) {
                        ...
                        if (
                          ...
                          (transceiver =
                            ...
                            edgeVersion < 15019 &&
                              (localCapabilities.codecs =
                                localCapabilities.codecs.filter(function (
                                  codec
                                ) {
                    ...
                    pc.transceivers.forEach(function (
                      ...
                      if (!(sdpMLineIndex + 1 > mediaSectionsInOffer)) {
                        ...
                        if (transceiver.stream) {
                          ...
                          "audio" === transceiver.kind
                            ? (localTrack =
                                transceiver.stream.getAudioTracks()[0])
                            : "video" === transceiver.kind &&
                              (localTrack =
                                transceiver.stream.getVideoTracks()[0]),
                            localTrack &&
                              edgeVersion >= 15019 &&
                              "video" === transceiver.kind &&
                              !transceiver.sendEncodingParameters[0].rtx &&
                    ...
                    return (
                      ...
                      sender &&
                        Object.keys(this._shimmedLocalStreams).forEach(
                          function (streamId) {
                            var idx =
                              pc._shimmedLocalStreams[streamId].indexOf(sender);
                            -1 !== idx &&
                  ...
                  if ("object" == typeof window && window.RTCPeerConnection) {
                    if (
                      ...
                      "getStreamById" in window.RTCPeerConnection.prototype ||
                        (window.RTCPeerConnection.prototype.getStreamById =
                          function (id) {
                            var result = null;
                            return (
                              this._localStreams &&
